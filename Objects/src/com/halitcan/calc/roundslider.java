...
public class roundslider extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "com.halitcan.calc.roundslider");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.halitcan.calc.roundslider.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(com.halitcan.calc.roundslider __ref,double _width,double _height) throws Exception{
__ref = this;
...
public String  _createthumb(com.halitcan.calc.roundslider __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
...
public String  _draw(com.halitcan.calc.roundslider __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
...
public String  _class_globals(com.halitcan.calc.roundslider __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
...
public String  _designercreateview(com.halitcan.calc.roundslider __ref,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
...
public int  _getvalue(com.halitcan.calc.roundslider __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
...
public String  _initialize(com.halitcan.calc.roundslider __ref,anywheresoftware.b4a.BA _ba,Object _callback,String _eventname) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="roundslider";
...
public String  _pnl_touch(com.halitcan.calc.roundslider __ref,int _action,float _x,float _y) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
...
public String  _setcirclecolor(com.halitcan.calc.roundslider __ref,int _nonvaluecolor,int _innercolor) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
...
public String  _setthumbcolor(com.halitcan.calc.roundslider __ref,int _bordercolor,int _innercolor) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
...
public String  _setvalue(com.halitcan.calc.roundslider __ref,int _v) throws Exception{
__ref = this;
RDebugUtils.currentModule="roundslider";
