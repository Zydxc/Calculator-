...
b4xinputtemplate._xdialog = RemoteObject.createNew ("com.halitcan.calc.b4xdialog");__ref.setField("_xdialog",b4xinputtemplate._xdialog);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xinputtemplate.class, "_setborder" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_bordercolor" /*RemoteObject*/ )));
...
public ResumableSub_Show(com.halitcan.calc.b4xinputtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xinputtemplate.class, "_validate" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_text" /*RemoteObject*/ )));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xinputtemplate.class, "_textfield1_enterpressed" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (com.halitcan.calc.b4xinputtemplate.class, "_isvalid" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_textfield1" /*RemoteObject*/ ).runMethod(true,"getText"))).<Boolean>get().booleanValue()) { 
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (com.halitcan.calc.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")));};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xinputtemplate.class, "_validate" /*RemoteObject*/ ,(Object)(_new));
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (com.halitcan.calc.b4xinputtemplate.class, "_isvalid" /*RemoteObject*/ ,(Object)(_new)),b4xinputtemplate.__c.getField(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (com.halitcan.calc.b4xdialog.class, "_setbuttonstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")),(Object)(_enabled));
 BA.debugLineNum = 96;BA.debugLine="SetBorder(bc)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xinputtemplate.class, "_setborder" /*RemoteObject*/ ,(Object)(_bc));
