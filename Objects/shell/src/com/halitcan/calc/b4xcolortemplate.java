...
public static RemoteObject _huebar = RemoteObject.declareNull("com.halitcan.calc.b4xcolortemplate._colorpickerpart");
public static RemoteObject _colorpicker = RemoteObject.declareNull("com.halitcan.calc.b4xcolortemplate._colorpickerpart");
public static RemoteObject _alphabar = RemoteObject.declareNull("com.halitcan.calc.b4xcolortemplate._colorpickerpart");
public static RemoteObject _borderscolor = RemoteObject.createImmutable(0);
public static RemoteObject _xdialog = RemoteObject.declareNull("com.halitcan.calc.b4xdialog");
