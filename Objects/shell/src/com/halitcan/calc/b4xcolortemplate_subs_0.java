...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_alphabarselectedchange" /*RemoteObject*/ ,(Object)(_x));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_update" /*RemoteObject*/ );
...
RemoteObject _cpp = RemoteObject.declareNull("com.halitcan.calc.b4xcolortemplate._colorpickerpart");
int _i = 0;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_drawcheckers" /*RemoteObject*/ ,(Object)(_cpp));
 };
 }
}Debug.locals.put("cpp", _cpp);
;
...
b4xcolortemplate._huebar = RemoteObject.createNew ("com.halitcan.calc.b4xcolortemplate._colorpickerpart");__ref.setField("_huebar",b4xcolortemplate._huebar);
b4xcolortemplate._colorpicker = RemoteObject.createNew ("com.halitcan.calc.b4xcolortemplate._colorpickerpart");__ref.setField("_colorpicker",b4xcolortemplate._colorpicker);
b4xcolortemplate._alphabar = RemoteObject.createNew ("com.halitcan.calc.b4xcolortemplate._colorpickerpart");__ref.setField("_alphabar",b4xcolortemplate._alphabar);
...
b4xcolortemplate._xdialog = RemoteObject.createNew ("com.halitcan.calc.b4xdialog");__ref.setField("_xdialog",b4xcolortemplate._xdialog);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_handleselectedcolorchanged" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)));
...
Debug.JustUpdateDeviceLine();
_cpp = RemoteObject.createNew ("com.halitcan.calc.b4xcolortemplate._colorpickerpart");Debug.locals.put("cpp", _cpp);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_setselectedhsvcolor" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_initialcolor" /*RemoteObject*/ )));
 };
...
Debug.JustUpdateDeviceLine();
_hsv = __ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_getselectedhsvcolor" /*RemoteObject*/ );Debug.locals.put("hsv", _hsv);Debug.locals.put("hsv", _hsv);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_updatebarcolor" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_huebarselectedchanged" /*RemoteObject*/ ,(Object)(_y));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_huebar" /*RemoteObject*/ ,__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_createpanelforbitmapcreator" /*RemoteObject*/ ,(Object)(BA.ObjectToString("hueBar")),(Object)(b4xcolortemplate.__c.getField(true,"False"))));
 BA.debugLineNum = 25;BA.debugLine="ColorPicker = CreatePanelForBitmapCreator(\"colors";
Debug.JustUpdateDeviceLine();
__ref.setField ("_colorpicker" /*RemoteObject*/ ,__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_createpanelforbitmapcreator" /*RemoteObject*/ ,(Object)(BA.ObjectToString("colors")),(Object)(b4xcolortemplate.__c.getField(true,"True"))));
 BA.debugLineNum = 26;BA.debugLine="AlphaBar = CreatePanelForBitmapCreator(\"alpha\", T";
Debug.JustUpdateDeviceLine();
__ref.setField ("_alphabar" /*RemoteObject*/ ,__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_createpanelforbitmapcreator" /*RemoteObject*/ ,(Object)(BA.ObjectToString("alpha")),(Object)(b4xcolortemplate.__c.getField(true,"True"))));
 BA.debugLineNum = 27;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_setselectedhsvcolor" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_colortohsv" /*RemoteObject*/ ,(Object)(_i))));
...
public ResumableSub_Show(com.halitcan.calc.b4xcolortemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_initialcolor" /*RemoteObject*/ ,__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_getselectedhsvcolor" /*RemoteObject*/ ));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_drawcolors" /*RemoteObject*/ );
 BA.debugLineNum = 160;BA.debugLine="HandleSelectedColorChanged(DONT_CHANGE, DONT_CHAN";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_handleselectedcolorchanged" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_dont_change" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_dont_change" /*RemoteObject*/ )));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).getField(false,"_titlebar" /*RemoteObject*/ ).runMethod(true,"setColor",__ref.runClassMethod (com.halitcan.calc.b4xcolortemplate.class, "_getselectedcolor" /*RemoteObject*/ ));
 };
