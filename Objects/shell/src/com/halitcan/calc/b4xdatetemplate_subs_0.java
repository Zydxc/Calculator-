...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_drawdays" /*RemoteObject*/ );
...
b4xdatetemplate._mdialog = RemoteObject.createNew ("com.halitcan.calc.b4xdialog");__ref.setField("_mdialog",b4xdatetemplate._mdialog);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_handlemouse" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _x)),(Object)(BA.numberCast(double.class, _y)),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("!",_action,BA.numberCast(double.class, _p.getField(true,"TOUCH_ACTION_UP"))))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_setdate" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_previousselecteddate" /*RemoteObject*/ )));
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_setyearsbuttonstate" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_drawbox" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_cvsbackground" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_highlightedcolor" /*RemoteObject*/ )),(Object)(_boxx),(Object)(_boxy));
 };
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_selectday" /*RemoteObject*/ ,(Object)(_newselectedday));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_hide" /*RemoteObject*/ );
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdialog" /*RemoteObject*/ ).runClassMethod (com.halitcan.calc.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_setdate" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_selecteddate" /*RemoteObject*/ )));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xdatetemplate.class, "_selectday" /*RemoteObject*/ ,(Object)(b4xdatetemplate.__c.getField(false,"DateTime").runMethod(true,"GetDayOfMonth",(Object)(_date))));
...
public ResumableSub_Show(com.halitcan.calc.b4xdatetemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
