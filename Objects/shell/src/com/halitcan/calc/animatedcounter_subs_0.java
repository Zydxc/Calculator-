...
_bmp = __ref.runClassMethod (com.halitcan.calc.animatedcounter.class, "_createbitmap" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbltemplate" /*RemoteObject*/ )));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.animatedcounter.class, "_setvalue" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.animatedcounter.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
 BA.debugLineNum = 52;BA.debugLine="setValue(getValue)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.animatedcounter.class, "_setvalue" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.halitcan.calc.animatedcounter.class, "_getvalue" /*RemoteObject*/ )));
 };
