...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xcombobox.class, "_raiseevent" /*void*/ );
...
Debug.JustUpdateDeviceLine();
_i = __ref.runClassMethod (com.halitcan.calc.b4xcombobox.class, "_getselectedindex" /*RemoteObject*/ );Debug.locals.put("i", _i);Debug.locals.put("i", _i);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (com.halitcan.calc.b4xcombobox.class, "_getitem" /*RemoteObject*/ ,(Object)(_i));
...
public ResumableSub_RaiseEvent(com.halitcan.calc.b4xcombobox parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
Debug.JustUpdateDeviceLine();
_index = __ref.runClassMethod (com.halitcan.calc.b4xcombobox.class, "_getselectedindex" /*RemoteObject*/ );Debug.locals.put("index", _index);Debug.locals.put("index", _index);
...
__ref.runClassMethod (com.halitcan.calc.b4xcombobox.class, "_setselectedindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));};
