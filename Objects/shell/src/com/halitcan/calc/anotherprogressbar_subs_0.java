...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.anotherprogressbar.class, "_updategraphics" /*RemoteObject*/ );
...
public ResumableSub_BusyLoop(com.halitcan.calc.anotherprogressbar parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Value"))),(Object)(RemoteObject.createImmutable((100)))))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.anotherprogressbar.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,(Object)(_v));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.anotherprogressbar.class, "_busyloop" /*void*/ );
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.anotherprogressbar.class, "_setvisible" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getVisible")));
