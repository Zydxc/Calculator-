...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.halitcan.calc.b4xbreadcrumb.class, "_draw" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_presseditem" /*RemoteObject*/ ,__ref.runClassMethod (com.halitcan.calc.b4xbreadcrumb.class, "_finditem" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y))));
...
Debug.JustUpdateDeviceLine();
_index = __ref.runClassMethod (com.halitcan.calc.b4xbreadcrumb.class, "_finditem" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
